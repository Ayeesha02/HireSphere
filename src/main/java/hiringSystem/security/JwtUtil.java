/**
 * JwtUtil.java
 * This class provides utility methods for generating, validating, and parsing JWT tokens.
...
public class JwtUtil {
    ...
    private static final long EXPIRATION_TIME = 86400000; // 24 hours in millisecond
